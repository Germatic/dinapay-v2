...
func checkoutBankDetails(paymentData map[string]any) *checkoutBankTransfer {
	...
	return &checkoutBankTransfer{
		...
		Reusable:     destinationMode == "reusable",
	}
}
