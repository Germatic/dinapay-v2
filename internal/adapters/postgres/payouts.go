...
func (s *Store) ListDashboardPayouts(ctx context.Context, accountID, merchantID string, o core.PayoutListOptions) (core.PayoutPage, error) {
	...
	rows, err := s.db.Query(ctx, dashboardPayoutSelect, merchantID, accountID, o.ExternalID, o.Status, o.Currency, o.CreatedAfter, o.CreatedBefore, o.ConfirmedAfter, o.ConfirmedBefore, cursorTime, cursor.ID, o.Limit+1)
	if err != nil {
...
const dashboardPayoutSelect = `WITH all_payouts AS (
 ...
 AND ($10::timestamptz IS NULL OR (creation_date,payout_id)<($10::timestamptz,$11)) ORDER BY creation_date DESC,payout_id DESC LIMIT $12`
